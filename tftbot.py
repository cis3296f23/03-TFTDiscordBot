...
async def tft_leaderboard(ctx):
    """Outputs the top 10 players in a particular region (defaults to NA)
...
async def rank_command(ctx, name):
    """Outputs an image of the icon for the player rank, plus their specific rank in text and their W/L ratio
